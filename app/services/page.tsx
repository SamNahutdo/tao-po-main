...
import { Star, Search, MapPin, Clock, Shield, MessageCircle, SlidersHorizontal,  Wrench, Home, Zap, Paintbrush, Car, Laptop} from "lucide-react"
...
export default function ServicesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <MobileHeader title="Find Services" />
      ...
      <div className="bg-white border-b px-4 py-4 space-y-3">
        ...
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600">{filteredProviders.length} providers found</span>
